 ...
 * @author Johny
 */
public class v_Plantilla extends javax.swing.JFrame {

    /**
     * Creates new form v_Plantilla
     */
    public v_Plantilla() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("DIR. ORGIEN");

        jLabel6.setText("DIR. DESTINO");
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "FECHA", "CONDUCTOR", "CAMION", "DIR ORIGEN", "DIR DESTINO", "CANTIDAD", "PRODUCTO", "CLIENTE"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(v_Plantilla.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new v_Plantilla().setVisible(true);
            }
        });
    }
